            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="p1 text-center">Final Amount</th>
                ...
                <?php 
                    $i = 1;
                    $orders = $conn->query("SELECT *, total_amount AS price_before_voucher, final_total AS price_after_voucher FROM `order_list` where client_id = '{$_settings->userdata('id')}' order by `status` asc, unix_timestamp(date_created) desc ");
                ...
                ?>
                    <tr>
                        ...
                        <td class="px-2 py-1 align-middle text-center"><?= number_format(floatval($row['price_before_voucher']), 2) ?></td>
                        <td class="px-2 py-1 align-middle text-center"><?= number_format(floatval($row['price_after_voucher']), 2) ?></td>
