...
--
-- Table structure for voucher codes
--
...
CREATE TABLE `vouchers` (
  ...
  CONSTRAINT `vouchers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `client_list` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
--
...
(1, 'VOUCHER10', 10.00, '2024-1-31', NULL, 0, NULL), -- Example voucher code with a 10% discount, expires on 31st December 2024, no user assigned, and usage limit of 100
(2, 'VOUCHER20', 20.00, '2024-1-10', NULL, 0, 100),  -- Example voucher code with a 20% discount, expires on 31st December 2023, no user assigned, and usage limit of 50
(3, 'VOUCHER30', 30.00, '2023-12-31', NULL, 0, 50); -- Example voucher code with a 30% discount, expires on 31st December 2025, no user assigned, and no usage limit
